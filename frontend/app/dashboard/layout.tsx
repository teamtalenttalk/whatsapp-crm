  ...
  // 3. Automation
  {
    ...
    group: {
      ...
      items: [
        ...
        { href: "/dashboard/ai-chatbot", label: "AI Chatbot (GPT)", icon: AIIcon },
  ...
  // 4. Campaigns
  {
    ...
    group: {
      ...
      items: [
        ...
        { href: "/dashboard/campaign-analytics", label: "Campaign Analytics", icon: ChartIcon },
        { href: "/dashboard/contacts", label: "Contacts", icon: ContactsIcon },
        { href: "/dashboard/segments", label: "Segments", icon: SegmentsIcon },
  ...
  // 6. Meetings
  {
    ...
    group: {
      ...
      items: [
        ...
        { href: "/dashboard/calendars", label: "Calendars", icon: CalendarsIcon },
      ],
    },
  },
  ...
  // 7. Reports & Analytics
  {
    ...
    group: {
      ...
      items: [
        ...
        { href: "/dashboard/customer-journey", label: "Customer Journey", icon: JourneyIcon },
      ],
    },
  },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-slate-900">
      ...
      {/* Sidebar */}
      <aside className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-slate-800 border-r border-slate-700 flex flex-col shrink-0 transform transition-transform lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-6 shrink-0">
          ...
          <button
            ...
            className="px-4 py-1.5 text-sm text-slate-400 hover:text-white border border-slate-600 rounded-lg hover:bg-slate-700 transition-colors"
          >
            Logout
          </button>
        </header>
